...
> Lineage: 3 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: todo · PII flags: 2 · Changelog: fresh
...
- key_hash (key)
- key_hash_key_version (key)

## Usage
```bash
# Install/upgrade schema
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package idempotency-keys -Apply
