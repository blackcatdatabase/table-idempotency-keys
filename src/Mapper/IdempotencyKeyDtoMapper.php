...
final class IdempotencyKeyDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'key_hash' => 'keyHash', 'payment_id' => 'paymentId', 'order_id' => 'orderId', 'gateway_payload' => 'gatewayPayload', 'redirect_url' => 'redirectUrl', 'created_at' => 'createdAt', 'ttl_seconds' => 'ttlSeconds' ];
    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'payment_id', 'order_id', 'ttl_seconds' ];
    /** @var string[] */
    ...
    /** @var string[] */
    private const NULLABLE    = [ 'payment_id', 'order_id', 'gateway_payload', 'redirect_url' ];
    ...
    public static function fromRow(array $row): IdempotencyKeyDto {
        ...
        return new IdempotencyKeyDto(...$vals);
    }
