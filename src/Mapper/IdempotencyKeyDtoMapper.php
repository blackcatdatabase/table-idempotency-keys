...
namespace BlackCat\Database\Packages\IdempotencyKeys\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO IdempotencyKeyDto:
...
final class IdempotencyKeyDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'tenant_id', 'payment_id', 'order_id', 'ttl_seconds' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [ 'gateway_payload' ];
    /** @var string[] */
     ...
     */
    public static function fromRow(array $row): IdempotencyKeyDto
    {
        /** @var IdempotencyKeyDto */
    ...
    public static function fromRowOrNull(?array $row): ?IdempotencyKeyDto
    {
     ...
     *
     * @param IdempotencyKeyDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(IdempotencyKeyDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(IdempotencyKeyDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(IdempotencyKeyDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,IdempotencyKeyDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,IdempotencyKeyDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(IdempotencyKeyDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,IdempotencyKeyDto>
     */
